...
<form method="post" class="form-horizontal" role="form">
								...
								<div class="form-group <?php if ( $wizard->get_error_state() ) { ?>has-error<?php }?>">
									...
									<div class="col-xs-12 col-sm-6" >
										...
										<input type="text" class="col-xs-12" id="inputError" name="license_key" placeholder="Лицензионный ключ" value="<?php if ($_POST['license_key']!='') {echo $_POST['license_key'];} else {echo $_SESSION['license_key'];};?>"  />
										<?php if ( $wizard->get_error_state() ) { ?>
