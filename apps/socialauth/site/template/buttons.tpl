<div class="socialauth-panel">
    ...
    {if $vk_login_enable==1}<a class="popup vkontakte" href="" alt="Войти через VK" title="Войти через VK"><img src="{$estate_folder}/apps/socialauth/img/vk_connect.svg"></a>{/if}
