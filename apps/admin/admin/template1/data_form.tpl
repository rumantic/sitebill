                    ...
                    <div class="box">
                        <div class="row">
                            {foreach from=$tab_elements item=element}
                                <div class="{if $element.type=='textarea' or $element.type=='textarea_editor' or $element.type=='uploads' or $element.type=='docuploads' or $element.type=='geodata'}{$formwideclass}{else}{$formsemiclass}{/if}">
