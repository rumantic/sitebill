    ...
    <div class="navbar-inner">
        <div class="container">
            ...
            <div class="nav pull-right">
                ...
                {if $admin ne ''}
                <div align="right"><a href="#search" id="search_toggle" class="btn btn-info"><i
    ...
    <tr class="row_head">
        ...
        <td width=13% class="row_title">
            ...
            {$L_DISTRICT}&nbsp;<a href="{$url}&order=district&asc=asc">&darr;</a>&nbsp;<a
                    href="{$url}&order=district&asc=desc">&uarr;</a></td>
        <td width=13% class="row_title">
            <!-- #section:plugins/input.tag-input -->
            <div class="inline-tags">
            ...
            {$L_STREET}&nbsp;<a href="{$url}&order=street&asc=asc">&darr;</a>&nbsp;<a
                    href="{$url}&order=street&asc=desc">&uarr;</a></td>
        <td width=13% class="row_title">
            <!-- #section:plugins/input.tag-input -->
            <div class="inline-tags">
        ...
        <tr valign="top"
            ...
            <td>
                ...
                {else}
                    ...
                    <a href="javascript:void(0);" rel="popover" class="userinfo_tooltipe_block" data-html="true"
                       data-placement="left" data-user-id="{$grid_items[i].user_id}"><span
                                class="user-info">{$grid_items[i].user}</span></a>
                {/if}
            </td>
            {if $admin !=''}
                <td nowrap>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            {if $grid_items[i].active == 1}
                                <li><a title="На сайте" href="{$grid_items[i].href}" target="_blank"
                                       class="btn btn-success"><i class="icon-white icon-forward"></i> На сайте</a></li>
                            {/if}
                            {if isset($show_contacts_enable) && $show_contacts_enable}
                                ...
                                {else}
                                    <li><img src="{$estate_folder}/img/contact-new.png" alt="{$L_CONTACTS_ARE_SHOWED}"
                                             title="{$L_CONTACTS_ARE_SHOWED}" border="0" width="16" height="16"/></li>
                                {/if}
                            ...
                            {if isset($sms_enable) && $sms_enable}
                                <li><a class="btn btn-success"
                                       ...
                                       href="{$estate_folder_control}?do=structure&subdo=sms&id={$grid_items[i].id}"><img
                                                ...
                                                title="{$L_SENDSMS_LC}" border="0" width="16" height="16"/> SMS</a></li>
                            {/if}
                    ...
                    <div class="btn-group">
                        ...
                        <a title="Удалить" onclick="return confirm('{$L_MESSAGE_REALLY_WANT_DELETE}');"
                           href="{$estate_folder_control}?{if $topic_id != ''}topic_id={$topic_id}&{/if}do=delete&id={$grid_items[i].id}"
