...
/**
 * Check whether variable is a Sitebill Error.
 *
 * @param mixed $thing Check if unknown variable is Sitebill Error object.
 * @return bool True, if Sitebill_Error. False, if not Sitebill_Error.
 */
function is_sitebill_error($thing) {
	if ( is_object($thing) && is_a($thing, 'Sitebill_Error') )
		return true;
	return false;
}
