...
$(document).ready(function () {
    ...
    var password_val = jabber_password;
		...
		if ( channel == 'local' ) {
		    Groupie.room = server_name + '@conference.sitebill.ru';
		} else if ( channel == 'bot' ) {
		    Groupie.room = 'bot.' + server_name + '@conference.sitebill.ru';
		} else {
                    Groupie.room = 'public@conference.sitebill.ru';
		}
                Groupie.nickname = login_val;
			
			    $(document).trigger('connect', {
				jid: login_val+'@sitebill.ru',
...
$(document).bind('connect', function (ev, data) {
    Groupie.connection = new Strophe.Connection(
        'https://sitebill.ru:7443/http-bind/');
