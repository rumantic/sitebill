...
$(document).ready(function () {
    var login_val = 'test5';
    var password_val = 'test234234KJKJ';
    
	        jQuery.ajax({
	        	url: 'https://www.sitebill.ru/apps/jabber/js/ajax.php',
	        	dataType: 'jsonp',
	        	data: {login: login_val, password: password_val, full_name: 'Vas Pup', email: 'vaspup1@etown.ru', group_name: 'vashdom.ru'},
...
$(document).bind('connect', function (ev, data) {
	...
	console.log('connect, login = ' + data.jid + ', password = ' +data.password );
