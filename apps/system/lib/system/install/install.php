            ...
            if ($stmt) {
                ...
                if ($ar['cid'] == 0) {
					...
					(6120, 'Автобокс', 3, 61, 20)            
					            ";
                    $stmt = $DBC->query($query);
                    //отключаем активность гаражей
                    $stmt = $DBC->query("update re_topic set published=0 where id=6");
...
//echo 'запуск install_manager sql<br>';
            ...
            if ($install_default) {
                ...
                $query_data[] = "INSERT INTO re_city (city_id,name,region_id) VALUES (2,'Владивосток',2)";
                ...
                $query_data[] = "INSERT INTO re_region (region_id,name,country_id) VALUES (2,'Приморский край',2)";
                ...
                $query_data[] = "INSERT INTO re_street (street_id,prefix,name,district_id) VALUES (2,null,'проспект Народный',2)";
