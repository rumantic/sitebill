...
class SiteBill_Krascap extends SiteBill {
    ...
    function main() {
        ...
        /* заглушка под вход имейджинатора - модуля возвращающего подогнанные фото */
        /* if(preg_match('/^im\/small\/(r|c|f)(\d+)x(\d+)\/(.*)\.(jpg|jpeg|gif|png)$/', $REQUESTURIPATH, $matches)){

          require_once SITEBILL_DOCUMENT_ROOT.'/apps/system/lib/components/imaginator/imaginator.php';
