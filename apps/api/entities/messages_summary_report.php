...
/**
 * messages summary report object
 * @author Kondin Dmitriy <kondin@etown.ru>
 */
class messages_summary_report extends \Object_Manager {
    /**
     * Constructor
     */
    function __construct() {
        parent::__construct();
        $this->table_name = 'messages_summary_report';
        $this->action = 'messages_summary_report';
    ...
    function create_view () {
        ...
        create view re_messages_summary_report as
        SELECT
            m.message_id, m.client_id, m.data_id, m.created_at, deal.deal_id, deal.status_id,
            c.company, concat(c.first_name, ' ', c.first_name) as fio, c.phone,
            concat(city.name, ', ', street.name, ' ', d.number) as address, d.square_all, d.cost_meter_per_month4rent,
        ...
        WHERE c.client_id=m.client_id AND d.id=m.data_id
        GROUP BY m.client_id, m.data_id
