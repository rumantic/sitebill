...
{if isset($form_elements.hash.table_id)}
    {assign var=current_el value=$form_elements.hash.table_id}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Имя модели содержащей данное поле"> <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
{/if}

{if isset($form_elements.hash.type)}
    {assign var=current_el value=$form_elements.hash.type}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Тип поля модели, который определяет его функционал, особенности, принцип отображения и видимость на формах и при автовыводах">
...
{if isset($form_elements.hash.active)}
    {assign var=current_el value=$form_elements.hash.active}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Активность элемента. Деактивированное состояние исключает элемент из модели, но не удаляет его физически, что позволяет, при потребности, быстро вернуть его в состав модели.">
                <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.name)}
    {assign var=current_el value=$form_elements.hash.name}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Системное имя поля. Может состоять из цифр, латинских букв и подчеркивания. Не должно содержать пробелы или начинаться с числа или подчеркивания. Должно быть длиннее 3-х символов. Фактически это имя, в большинстве случаев, является именем соответствующей колонки в таблице БД.">
                <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.title)}
    {assign var=current_el value=$form_elements.hash.title}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Публичное имя элемента модели. Будет отображаться на сайте и в формах."> <i
                        class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
    {foreach $langs item=lang}
        ...
        {if isset($hash[$langt])}
            <div class="form_element control-group" alt="{$hash[$langt].name}">
                <label class="control-label">{$hash[$langt].title}{if $hash[$langt].required eq 1}
                        <span style="color: red;">*</span>
                    {/if}</label>
...
{if 1==0}
    ...
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content=""> <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
{/if}
...
{if isset($form_elements.hash.active_in_topic)}
    {assign var=current_el value=$form_elements.hash.active_in_topic}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Определяет видимость элемента в зависимости от выбраного пункта Структуры"> <i
                        class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.hint)}
    {assign var=current_el value=$form_elements.hash.hint}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Подсказка к элементву в виде простого текста"> <i
                        class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.value)}
    {assign var=current_el value=$form_elements.hash.value}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Значение по-умолчанию, которое будет устанавливаться для элемента в случае его незаполнения пользователем">
                <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.primary_key_table)}
    {assign var=current_el value=$form_elements.hash.primary_key_table}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Внешняя таблица-хранилище значений-вариантов для поля select_by_query"> <i
                        class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.primary_key_name)}
    {assign var=current_el value=$form_elements.hash.primary_key_name}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Название поля внешней таблицы-хранилища которое служит ключем для связи с текущим полем (для поля select_by_query)">
                <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.value_name)}
    {assign var=current_el value=$form_elements.hash.value_name}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Название поля внешней таблицы-хранилища которое служит хранилищем значения для связи с текущим полем (для поля select_by_query)">
                <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.query)}
    {assign var=current_el value=$form_elements.hash.query}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Формальный запрос к внешней таблице на выборку списка вариантов значений поля"> <i
                        class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.title_default)}
    {assign var=current_el value=$form_elements.hash.title_default}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Текстовое название нулевого элемента списка выбора вариантов. Будет отображаться как опция отсутствия выбора.">
                <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.value_default)}
    {assign var=current_el value=$form_elements.hash.value_default}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Значение нулевого элемента списка выбора вариантов. Должно быть 0 для обозначения отсутствия выбора.">
                <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.value_table)}
...
{if isset($form_elements.hash.value_primary_key)}
...
{if isset($form_elements.hash.value_field)}
...
{if isset($form_elements.hash.assign_to)}
...
{if isset($form_elements.hash.dbtype)}
    {assign var=current_el value=$form_elements.hash.dbtype}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Указывает обязательность хранения значения поля в таблице БД. Для вспомогательных полей не требующих сохранения или обрабатывающихся отдельно (напр. captcha) должно быть разотмечено.">
                <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.select_data)}
    {assign var=current_el value=$form_elements.hash.select_data}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Набор опций выбора в формате пар {literal}{key~~value}{/literal}. key - оптимально числовое значение. Для нулевого значения key равен нулю, либо пара не указывается.">
                <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.table_name)}
    {assign var=current_el value=$form_elements.hash.table_name}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Cпецифично для полей типа uploadify."> <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
{/if}

{if isset($form_elements.hash.primary_key)}
...
{if isset($form_elements.hash.primary_key_value)}
...
{if isset($form_elements.hash.action)}
...
{if isset($form_elements.hash.entity)}
...
{if isset($form_elements.hash.combo)}
    {assign var=current_el value=$form_elements.hash.combo}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Использование combobox-виджета для элементов выпадающего списка. В связи со сложность адаптации к новым шаблонам поддержка прекращена. Не поддерживается.">
                <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.required)}
    {assign var=current_el value=$form_elements.hash.required}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Признак обязательности значения. Неуказанным значением считается: для текстовых полей - пустое значение, для полей выбора - нулевой выбор. Не имеет значения для чекбоков и контролируется дополнительными функциями для полей хранения изображений.">
                <i class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.unique)}
    {assign var=current_el value=$form_elements.hash.unique}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Признак контроля уникальности значения. Не используется."> <i
                        class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
...
{if isset($form_elements.hash.parameters)}
    {assign var=current_el value=$form_elements.hash.parameters}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Набор параметров точной настройки элемента."> <i
                        class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
            <div id="params_setter">
                <ul>
                    ...
                    <li><a href="" data-task="api_call">API call</a></li>
                    <li><a href="" data-task="structure_leveled">Structure leveled (пошаговый ввод из типов)</a></li>
                    <li><a href="" data-task="def_link">URL-декоратор (для кликабельных ссылок)</a></li>
                    <li><a href="" data-task="confirm_mobile">Подтверждать мобильный телефон по SMS (для типа mobile)</a></li>
                    <li><a href="" data-task="whatstapp_decorator">WhatstApp decorator (ссылка на whatsapp-чат)</a></li>
                </ul>
        ...
        $(document).ready(function () {
            ...
            $("#params_setter a").click(function (e) {
                ...
                if (task == 'uploads_full') {
                    ...
                    hasAct = true;
                } else if (task == 'api_call') {
                    if (-1 === $.inArray('api_version', exp)) {
                        pr.find('input').eq(0).val('api_version');
                        pr.find('input').eq(1).val('api');
                        new_elements.push(pr);
                        pr = pr.clone();
                    }
                    if (-1 === $.inArray('api_name', exp)) {
                        pr.find('input').eq(0).val('api_name');
                        pr.find('input').eq(1).val('action_name');
                        new_elements.push(pr);
                        pr = pr.clone();
                    }
                    if (-1 === $.inArray('api_method', exp)) {
                        pr.find('input').eq(0).val('api_method');
                        pr.find('input').eq(1).val('method_name');
                        new_elements.push(pr);
                        pr = pr.clone();
                    }
                    if (-1 === $.inArray('api_params', exp)) {
                        pr.find('input').eq(0).val('api_params');
                        pr.find('input').eq(1).val('{}');
                        new_elements.push(pr);
                        pr = pr.clone();
                    }
                    hasAct = true;
                } else if (task == 'structure_leveled') {
                    if (-1 === $.inArray('type', exp)) {
                        pr.find('input').eq(0).val('type');
                        pr.find('input').eq(1).val('leveled');
                        new_elements.push(pr);
                        pr = pr.clone();
                    }
                    if (-1 === $.inArray('level_required', exp)) {
                        pr.find('input').eq(0).val('level_required');
                        pr.find('input').eq(1).val('0');
                        new_elements.push(pr);
                        pr = pr.clone();
                    }
                    hasAct = true;
                } else if (task == 'confirm_mobile') {
                    if (-1 === $.inArray('confirm_mobile', exp)) {
                        pr.find('input').eq(0).val('confirm_mobile');
                        pr.find('input').eq(1).val('1');
                        new_elements.push(pr);
                        pr = pr.clone();
                    }
                    hasAct = true;
                } else if (task == 'whatstapp_decorator') {
                    if (-1 === $.inArray('whatstapp_decorator', exp)) {
                        pr.find('input').eq(0).val('whatstapp_decorator');
                        pr.find('input').eq(1).val('1');
                        new_elements.push(pr);
                        pr = pr.clone();
                    }
                    hasAct = true;
                } else if (task == 'def_link') {
                    if (-1 === $.inArray('gcomposed', exp)) {
                        pr.find('input').eq(0).val('gcomposed');
                        pr.find('input').eq(1).val('1');
                        new_elements.push(pr);
                        pr = pr.clone();
                    }
                    ...
                    if (-1 === $.inArray('cols', exp)) {
                        pr.find('input').eq(0).val('cols');
                        new_elements.push(pr);
                        pr = pr.clone();
                    }
                    if (-1 === $.inArray('rows', exp)) {
                        pr.find('input').eq(0).val('rows');
                        new_elements.push(pr);
                    }
                    hasAct = true;
                } else if (task == 'rules') {
...
{if isset($form_elements.hash.tab)}
    {assign var=current_el value=$form_elements.hash.tab}
    <div class="form_element control-group" alt="{$current_el.name}">
        <label class="control-label">{$current_el.title}{if $current_el.required eq 1}
                <span style="color: red;">*</span>
            {/if} <a href="javascript:void(0);" rel="popover" class="tooltipe_block btn btn-info btn-mini"
                     data-content="Закладка на форме в которой будет размещен элемент."> <i
                        class="icon-question-sign icon-white"></i></a></label>
        <div class="form_element_html controls">{$current_el.html}
        </div>
    </div>
