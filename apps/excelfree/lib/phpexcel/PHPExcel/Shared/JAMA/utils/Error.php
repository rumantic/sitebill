...
$error['DE'][PolymorphicArgumentException] = "UnzulГ¤ssiges Argumentmuster fГјr polymorphe Funktion.";
...
$error['DE'][ArgumentTypeException] = "UnzulГ¤ssige Argumentart.";
...
$error['DE'][ArgumentBoundsException] = "UnzulГ¤ssige Argumentstrecke.";
...
$error['DE'][PrecisionLossException] = "Bedeutender PrГ¤zision Verlust ermittelte.";
...
$error['DE'][MatrixSPDException] = "Bedeutender PrГ¤zision Verlust ermittelte.";
