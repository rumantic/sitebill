...
{if $user_data}
    {$user_data.fio.title}: {$user_data.fio.value} {if $user_data.phone.value != ''}, {$user_data.phone.title}: {$user_data.phone.value}{/if}
    {if $user_data.mobile.value != ''}, {$user_data.mobile.title}: {$user_data.mobile.value}{/if}
{/if}
