                            ...
                            <div class="property">
                                <div class="image">
                                    ...
                                    {if $new_grid_item.img != '' }
                                        <img src="{mediaincpath data=$new_grid_item.img[0] type='preview'}" class="previewi">
                                    {else}
                                        ...
                                        <table class="contact">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{if $apps_contact_address != ''}{$apps_contact_address}{else}Россия<br>Красноярск<br>Батурина, 19<br>{/if}</td>
                                                </tr>
                                                <tr>
                                                    <th class="phone">{$L_PHONE}:</th>
                                                    <td>{if $apps_contact_phone != ''}{$apps_contact_phone}{else}8 800 250-99-31{/if}</td>
                                                </tr>
                                                <tr>
                    ...
                    <div id="footer-inner">
                        <div class="row">
                            <div class="span6 copyright">
                                <p><editable id="copyright_edit" data-file="footer.tpl">{_e t="Сделано на"} <a href="http://www.sitebill.ru" target="_blank">CMS SiteBill</a></editable></p>
                            </div><!-- /.copyright -->
                            ...
                            <div class="span6 share">
                                <div class="content">
                                    <ul class="menu nav">
                                        ...
                                        <li class="leaf"><a href="https://vk.com" class="vk">vk.com</a></li>
                                        ...
                                        <li class="leaf"><a href="http://www.telegram.com" class="telegram">Telegram</a></li>
                                        <li class="last leaf"><a href="http://www.instagram.com" class="instagram">Instagram</a></li>
                                    </ul>
                                </div><!-- /.content -->
                            </div><!-- /.span6 -->
                        </div><!-- /.row -->
