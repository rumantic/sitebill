...
8. [Доработка шаблона franch](docs/COMPLEX_WIDGET_DOCUMENTATION.md) - Инструкция по выводу ЖК на главной странице
9. [Документация шаблона Realia](docs/REALIA_TEMPLATE.md) - Полное руководство по редактированию и доработке шаблона Realia
